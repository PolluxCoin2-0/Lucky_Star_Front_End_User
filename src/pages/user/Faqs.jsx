        ...
        <div className="space-y-6">
          <div className="">
            <details className="group bg-gradient-to-r from-[#FF4B00] to-[#CFC800] rounded-lg">
              <summary className="flex cursor-pointer items-center justify-between p-5 text-lg font-semibold text-white group-open:bg-gradient-to-r from-[#FF4B00] to-[#CFC800] 
              rounded-t-lg">
